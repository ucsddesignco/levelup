export const ShowcaseTeams = [
  ...
  },
  {
    ...
    description: "NextStore bridges the gap between individual small business owners experiencing similar challenges. We aim to empower small business owners through community to continue delivering positive impacts to communities all over the world.",
    case_study_link: "https://www.figma.com/proto/vaImdfH24TfTrOQ6Fh2LdO/NextStore?node-id=1367%3A11498&scaling=min-zoom"
  },
  {
    team_name: "4-YELP",
    ...
    description: "NextStore bridges the gap between individual small business owners experiencing similar challenges. We aim to empower small business owners through community to continue delivering positive impacts to communities all over the world.",
    case_study_link: "https://docs.google.com/document/d/1T3FB7S9o_Apx9cO7blwByKwL-f9wgW6EZrN8euzx88Y/edit"
  }
];
